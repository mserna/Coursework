...
class Decks {
    ...
    public Decks(int n) {
        ...
        Collections.copy(originalDecks, dealDecks);
    }
    ...
    public List<Card> deal(int numberCards) throws PlayingCardException {
        ...
        if (numberCards > dealDecks.size()) {
            throw new PlayingCardException("Unable to deal " + numberCards + " cards.  Deck only has " + dealDecks.size() + " cards.");
        }
        List<Card> dealtCards = new ArrayList<Card>(numberCards);
